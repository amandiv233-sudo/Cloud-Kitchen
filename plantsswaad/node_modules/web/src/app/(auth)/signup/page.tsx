                ...
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    ...
                    <form className="space-y-6" onSubmit={handleSignup}>
                        <div>
                            ...
                            <div className="mt-1">
                                <input type="text" required value={fullName} onChange={e => setFullName(e.target.value)} className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-nature-500 focus:border-nature-500 sm:text-sm" placeholder="John Doe" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input type="tel" required value={phone} onChange={e => setPhone(e.target.value.replace(/\D/g, '').slice(0, 15))} className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-nature-500 focus:border-nature-500 sm:text-sm" placeholder="9876543210" />
                            </div>
                        </div>
