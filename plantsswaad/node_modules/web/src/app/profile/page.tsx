            ...
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="md:col-span-1 bg-white p-6 rounded-2xl shadow-sm border border-earth-100 h-fit">
                        <h2 className="text-xl font-bold mb-6 border-b pb-4">Profile Details</h2>
                        ...
                        <form onSubmit={handleUpdateProfile} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 border rounded-md focus:ring-nature-500 focus:border-nature-500"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 border rounded-md focus:ring-nature-500 focus:border-nature-500 bg-gray-50"
