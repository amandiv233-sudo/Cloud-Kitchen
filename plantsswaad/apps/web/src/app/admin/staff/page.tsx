...
type Role = 'customer' | 'chef' | 'sales' | 'delivery' | 'admin';
  ...
  return (
    <div className="p-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-nature-900">
          Staff Management
        </h1>
      </div>
          ...
          <table className="w-full text-left">
            ...
            <tbody>
              {staff.map((user) => (
                <tr
                  key={user.id}
                  className="border-b border-nature-100 hover:bg-nature-50"
                >
              ...
              {staff.length === 0 && (
                <tr>
                  <td
                    colSpan={4}
                    className="p-8 text-center text-nature-500"
                  >
                    No users found.
                  </td>
                </tr>
