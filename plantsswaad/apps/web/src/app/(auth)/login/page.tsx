                ...
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    ...
                    <form className="space-y-6" onSubmit={handlePhoneLogin}>
                        <div>
                            ...
                            <div className="mt-1">
                                <input type="tel" placeholder="e.g. 9876543210" required value={phone} onChange={e => setPhone(e.target.value.replace(/\D/g, '').slice(0, 15))} className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-nature-500 focus:border-nature-500 sm:text-sm text-gray-900 placeholder:text-gray-400 bg-white" />
                            </div>
                        </div>
